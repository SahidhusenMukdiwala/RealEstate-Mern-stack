        ...
        <div className='Services mb-4'>
            <div className="main flex flex-col gap-7">
                ...
                <div className="service-card  duration-[1s] cursor-pointer flex gap-3 justify-evenly flex-wrap">
                    <div className="service-card-1 border p-10 shadow-lg border-b-2 border-b-red-900 rounded-lg hover:scale-105 hover:translate-y-[-10px] duration-[1s]">
                    ...
                    <div className="service-card-1 border p-3 shadow-lg border-b-2 border-b-red-900 rounded-lg hover:scale-105 hover:translate-y-[-10px] duration-[1s]">
                        <img src={img1} alt="cardImg" className='mt-7 mx-auto w-[100px] h-[100px] sm:w-[200px] sm:h-[200px] rounded-full ' />
