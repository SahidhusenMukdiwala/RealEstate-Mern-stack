...
const About = () => {
  return (
    <div className='p-5 flex justify-around gap-3 flex-wrap' >
      <div className="border p-3 flex flex-col gap-3 flex-wrap shadow-md cursor-pointer hover:shadow-xl hover:scale-105 hover:bg-gray-700 hover:text-white transition-all">
      ...
      <div className="border p-3 flex flex-col gap-3 flex-wrap shadow-md cursor-pointer hover:shadow-xl hover:scale-105 hover:bg-slate-700 hover:text-white transition-all">
