...
function UpdateListing() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        console.log("CurrenrUserId", userId)
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <button disabled={loading || upload} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-85'>{loading ? 'Update ....' : 'Update List'}</button>
        </div>
    </form>
</main>
  )
